...
CREATE TABLE Plays (
	...
	-- Time.now() = 1768645323 - 1786854321 = 10202 / 3600
...
(4, '최유진', 'HeaterQueen', 34, '2024-06-11'), 
...
-- 4. 'S' 등급 아이템 조회
SELECT * FROM Item WHERE item_grade = 'S';
...
ALTER TABLE Item ADD COLUMN is_sellable BOOLEAN DEFAULT TRUE;
TABLE Item;
...
-- 3. 모든 유저의 기본 접속상태를 ONLINE으로 설정한다.
...
UPDATE Item SET item_price = 700 WHERE item_name = '회복포션';
